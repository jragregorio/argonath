...
/**
 * Dashboard chrome: theme, realtime, PTR (Capacitor), visibility refresh.
 * NativeAppResumeRefresh / FCM deep-link left out after Capacitor client crashes
 * (visibility soft-refresh covers badge freshness on resume).
