...
/**
 * Native extras (pull-to-refresh, resume refresh, push deep links) temporarily
 * omitted from the shell after a Capacitor client crash on the remote WebView.
 * Re-enable behind window.Capacitor-only helpers once production is stable.
 */
